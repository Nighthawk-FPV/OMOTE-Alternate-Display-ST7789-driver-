...
LGFX::LGFX(void) 
{
  ...
  { 
    ...
    cfg.i2c_port   = 0;          // Select I2C port (usually 0 or 1)
    cfg.i2c_addr   = 0x38;       // I2C address of your touch IC (e.g. 0x14 for GT911, 0x38 for FT5x06)
    cfg.pin_sda    = SDA_GPIO;         // Set your specific SDA pin (e.g., GPIO 19)
    cfg.pin_scl    = SCL_GPIO;         // Set your specific SCL pin (e.g., GPIO 20)
    cfg.x_min      = 0;    
    cfg.x_max      = 239;  
    cfg.y_min      = 0;    
    cfg.y_max      = 319;  
